...
namespace UCS.Core.Crypto.Sodium
{
    ...
    public static class Utilities
    {
        ...
        {
            /// <summary>
            ///     a hex string without seperators.
            /// </summary>
            None,

            /// <summary>
            ///     a hex string with colons (dd:33:dd).
            /// </summary>
            Colon,

            /// <summary>
            ///     a hex string with hyphens (dd-33-dd).
            /// </summary>
            Hyphen,

            /// <summary>
            ///     a hex string with spaces (dd 33 dd).
            /// </summary>
            Space
        }
        ...
        /// <remarks>
        ///     This method don`t use libsodium, but it can be useful for generating human readable fingerprints.
        /// </remarks>
