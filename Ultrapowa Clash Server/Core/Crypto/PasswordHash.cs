...
{
    /// <summary>
    /// Hashes passwords using the argon2i and scrypt algorithm
    /// </summary>
    public class PasswordHash
    {
        ...
        /// <summary>
        /// Is an identifier for the algorithm to use and should be currently set to crypto_pwhash_ALG_DEFAULT.
        /// </summary>
        ...
        /// <summary>
        /// Represents predefined and useful limits for ScryptHashBinary() and ScryptHashString().
        /// </summary>
        public enum Strength
        {
            /// <summary>
            /// For interactive sessions (fast: uses 16MB of RAM).
            /// </summary>
            Interactive,

            /// <summary>
            /// For normal use (moderate: uses 100MB of RAM).
            /// </summary>
            ...
            /// <summary>
            /// For more sensitive use (moderate: uses 128MB of RAM).
            /// </summary>
            MediumSlow,

            /// <summary>
            /// For highly sensitive data (slow: uses more than 1GB of RAM).
            /// </summary>
            Sensitive
        }

        /// <summary>
        /// Represents predefined and useful limits for ArgonHashBinary() and ArgonHashString().
        /// </summary>
        ...
        /// <summary>
        /// Generates a random 16 byte salt for the Argon2i algorithm.
        /// </summary>
        ...
        /// <param name="limit">The limit for computation.</param>
        /// <returns>
        /// Returns an zero-terminated ASCII encoded string of the computed password and hash.
        /// </returns>
        /// <exception cref="ArgumentNullException"></exception>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        /// <exception cref="OutOfMemoryException"></exception>
        ...
        /// <summary>
        /// Verifies that a hash generated with ArgonHashString matches the supplied password.
        /// </summary>
        ...
        /// <summary>
        /// Generates a random 32 byte salt for the Scrypt algorithm.
        /// </summary>
        /// <returns>Returns a byte array with 32 random bytes</returns>
        ...
        /// <summary>
        /// Verifies that a hash generated with ScryptHashString matches the supplied password.
        /// </summary>
        /// <param name="hash">The hash.</param>
        /// <param name="password">The password.</param>
        /// <returns><c>true</c> on success; otherwise, <c>false</c>.</returns>
